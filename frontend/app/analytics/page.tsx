                  ...
                  <div className="grid grid-cols-2 gap-2 mt-4">
                    {categoryData.map((category, index) => (
                      <div key={index} className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-muted-foreground ml-auto">{category.percentage}%</span>
                      </div>
                    ))}
                  </div>
                </CardContent>
                      ...
                      <div key={index} className="p-4 border rounded-lg">
                        ...
                        <div className="mt-3">
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div className="bg-blue-600 h-2 rounded-full" style={{ width: `${product.score}%` }}></div>
                          </div>
                        </div>
                      </div>
                    ))}
                    ...
                    {inventoryStatus.map((item, index) => (
                      <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                        ...
                        <div className="text-right">
                          ...
                          {item.reorderPoint && (
                            <p className="text-xs text-muted-foreground mt-1">Reorder at {item.reorderPoint}</p>
                          )}
                        </div>
                      </div>
                    ))}
                        ...
                        {customerGeography.map((geo, index) => (
                          <div key={index} className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm text-muted-foreground w-10">{geo.percentage}%</span>
                            </div>
                          </div>
                        ))}
                      </div>
                ...
                <CardContent>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className="p-3 bg-green-50 rounded-lg">
                      <h5 className="font-medium text-green-900">Avg CLV</h5>
                      <p className="text-2xl font-bold text-green-900">$2,847</p>
                    </div>
                    <div className="p-3 bg-blue-50 rounded-lg">
                      <h5 className="font-medium text-blue-900">Retention Rate</h5>
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={trafficTrends}>
                      ...
                      <Area type="monotone" dataKey="pageViews" stroke="#3B82F6" fill="#3B82F6" fillOpacity={0.3} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </CardContent>
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={financialForecast}>
                      ...
                      <YAxis />
                      <Tooltip />
                      <Area type="monotone" dataKey="revenue" fill="#10B981" fillOpacity={0.3} stroke="#10B981" />
...
const revenueBreakdown = [
  { category: "Product Sales", description: "Direct product revenue", amount: 127450, change: 18.2 },
  { category: "Shipping Fees", description: "Shipping and handling", amount: 8950, change: 12.5 },
  { category: "Premium Listings", description: "Featured product fees", amount: 2340, change: -5.2 },
