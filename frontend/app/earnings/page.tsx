                  ...
                  {transactionHistory.map((transaction) => (
                    <div key={transaction.id} className="flex items-center justify-between p-4 border rounded-lg">
                      ...
                      <div className="text-right">
                        ...
                        <Badge variant={getTransactionStatusVariant(transaction.status)}>{transaction.status}</Badge>
                      </div>
                    </div>
                  ))}
                </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-blue-50 p-3 rounded-md">
                        <p className="text-sm text-blue-700">
                          <strong>Note:</strong> Withdrawals are processed within 1-3 business days depending on the
                          method selected.
                        </p>
                      </div>
                    </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-amber-50 p-3 rounded-md">
                  <p className="text-sm text-amber-700">
                    <strong>Tax Season Reminder:</strong> Your 1099 forms will be available by January 31st for the
                    previous tax year.
                  </p>
                </div>
              </CardContent>
