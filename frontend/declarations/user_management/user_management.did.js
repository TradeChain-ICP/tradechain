export const idlFactory = ({ IDL }) => {
  ...
  const Result_4 = IDL.Variant({ 'ok' : Document, 'err' : IDL.Text });
  ...
  return IDL.Service({
    'addFunds' : IDL.Func([IDL.Nat, TokenType], [Result], []),
    'deleteDocument' : IDL.Func([IDL.Text], [Result], []),
    'getAllDocuments' : IDL.Func([], [IDL.Vec(Document)], ['query']),
    'getBalance' : IDL.Func([TokenType], [Result_5], []),
    'getCurrentUser' : IDL.Func([], [Result_1], []),
    'getDocument' : IDL.Func([IDL.Text], [Result_4], []),
    ...
    'getUserDocuments' : IDL.Func([], [IDL.Vec(Document)], []),
    ...
    'setWalletLock' : IDL.Func([IDL.Principal, IDL.Bool], [Result], []),
    ...
    'updateKYCStatus' : IDL.Func([KYCStatus], [Result_1], []),
    ...
    'validateSession' : IDL.Func([], [Result_1], []),
    'verifyDocument' : IDL.Func([IDL.Text, IDL.Bool], [Result], []),
  });
};
